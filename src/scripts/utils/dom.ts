 ...
 */
const querySelectorAll = <T extends HTMLElement>(selector: string): NodeListOf<T> =>
 ...
 */
const getElementById = <T extends HTMLElement>(id: string): T => document.getElementById(id) as T;
